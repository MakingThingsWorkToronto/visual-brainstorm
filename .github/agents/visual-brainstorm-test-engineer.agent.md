...
---
Read [the authoritative registry](../../.claude/agentic-surface-registry.json), [the Copilot adapter index](../agentic-surface-map.json), [test-engineer](../../.claude/agents/test-engineer.md), [build-check](../../.claude/commands/build-check.md), and [testing-observability](../../wiki/System/testing-observability.md).
